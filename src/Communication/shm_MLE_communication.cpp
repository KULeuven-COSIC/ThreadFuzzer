...
SHM_MLE_Communication::SHM_MLE_Communication() : SHM_Layer_Communication(static_cast<int>(EnumMutex::SHM_MUTEX_MLE)) {}

void SHM_MLE_Communication::send(Packet &packet) {
...
Packet SHM_MLE_Communication::receive() {
